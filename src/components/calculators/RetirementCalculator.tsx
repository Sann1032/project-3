          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                onChange={(e) => setValues({ ...values, inflationRate: Number(e.target.value) })}
                className="pl-10 w-full p-2 border rounded-md"
                step="0.1"
              />
            </div>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <p className="text-xl font-bold text-blue-600">
                ${inflationAdjusted.toLocaleString(undefined, { maximumFractionDigits: 0 })}
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-xl font-bold text-green-600">
                ${((inflationAdjusted * 0.04) / 12).toLocaleString(undefined, { maximumFractionDigits: 0 })}
              </p>
            </div>
          </div>
        </div>
